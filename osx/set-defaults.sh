...
sudo scutil --set ComputerName "Hubbe2"
sudo scutil --set HostName "Hubbe2"
sudo scutil --set LocalHostName "Hubbe2"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "Hubbe2"
...
defaults write NSGlobalDomain AppleLanguages -array "sv" "en" "es"
...
defaults write org.m0k.transmission IncompleteDownloadFolder -string "${HOME}/Documents/Downloads/Torrents"
